...
export default class BaseRestfulApiPayload {
   ...
   *
   * @returns {Array<['body', *]>} Array of body entries.
   */
  generateBodyEntry () {
...
/**
 * @typedef {typeof BaseRestfulApiPayload<B>} PayloadCtor
 * @template {RestfulApiRequestBody} [B = null]
 */

/**
 * @typedef {InstanceType<PayloadCtor<B>>} Payload
 * @template {RestfulApiRequestBody} [B = null]
 */
