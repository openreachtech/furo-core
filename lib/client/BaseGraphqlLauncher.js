...
export default class BaseGraphqlLauncher {
   ...
   *
   * @abstract
   * @returns {furo.PayloadCtor<*>} Payload class.
   * @throws {Error} This function must be inherited.
   */
  static get Payload () {
    throw new Error('this function must be inherited')
   ...
   * @param {{
   *   payload: furo.Payload<*>
   *   sink?: Partial<import('../tools/ProgressHttpFetcher').ProgressHttpFetcherSink>
   * }} params - Parameters.
 ...
 *   result: object | null
 *   abortedReason?: import('./graphql/BaseGraphqlCapsule.js').LAUNCH_ABORTED_REASON
 * }} CapsuleParams
 */
