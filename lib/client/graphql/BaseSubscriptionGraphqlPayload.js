 ...
 *
 * @template {GraphqlType.RequestVariables} SV - Type of variables for schema.
 */
export default class BaseSubscriptionGraphqlPayload {
   ...
   *   }
   * }} params - Parameters.
   * @returns {GraphqlType.RequestVariables} Variables.
   */
 ...
 * @template {GraphqlType.RequestVariables} V
 */
